...
Working through how to structure agentic development, I have explored how to write specifications with enough precision that the agent has something real to execute against, how to structure the execution loop so context does not rot across sessions, and how to craft acceptance criteria that are verifiable rather than aspirational. Underneath all of that sits a question that keeps nagging at me: how do you know if the agent is actually getting better over time?
